const aktivo = {
    ...
    inputs: {
        ...
        home: {
           buttons: [
               {
                   name: 'Ny aktivitet',
                   function: 'newActivity', // eksempel funksjon, brukes gjerne til onClick
                   cssClasses: [
                       'btn'
                   ]
               },
    ...
    data: {
        ...
        users: [
            {
                ...
                archive: [  // can be limited to a number (for example the 20 most recently modified).
        ...
        filters: [
            {
                name: 'filter1',
                value: null, // f.eks antall kroner
            },
            {
                name: 'filter2',
                value: null,
